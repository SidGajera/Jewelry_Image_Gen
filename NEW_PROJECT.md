...
- **Higgsfield MCP** (image generation): the production model (`config/project_manifest.json`), 2 credits / 2K image. Needs `generate_image`, `media_import_url`, `balance`, `transactions`.
