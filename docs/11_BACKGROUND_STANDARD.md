...
Use the exact cloth material shown in the reference images (soft matte cotton-like jewelry-pouch fabric with a fine even grain). This material is LOCKED.
Do NOT replace it with: silk, satin, linen, generic cotton, velvet, marble, paper, leather, visible-weave fabric, or any other material. Reuse the same material for every catalog image.
